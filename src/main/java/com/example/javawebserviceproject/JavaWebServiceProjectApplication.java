...
public class JavaWebServiceProjectApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
       ...
       userRepository.save(new AppUser("nico", passwordEncoder.encode("teamswag!"), List.of(Role.ADMIN)));
        userRepository.save(new AppUser("tim", passwordEncoder.encode("teamswag!"), List.of(Role.USER)));
        userRepository.save(new AppUser("elvis", passwordEncoder.encode("teamswag!"), List.of(Role.USER)));
